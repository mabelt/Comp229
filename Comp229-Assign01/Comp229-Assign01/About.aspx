    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>Restock medicine inventory</li>
                <li>Assist on-site pharmacist and pharmacy assistants</li>
                <li>Keep work environment clean</li>
            </ul>
        </div>
        <div class="col-md-6" style="text-align: right">
            <h4>Seasonal Employee</h4>
            Flora Flowers & Gifts
        </div>
        <div class="col-md-6">
            <p></p>
            ...
            <p>Reports to: Chau</p>
            <ul>
                <li>Complete daily schedule</li>
                <li>Assist the team leaders</li>
                <li>Maintain flowers, equipment and tools</li>
                <li>Prepare, wrap and package flowers</li>
            </ul>
        </div>
        <div class="col-md-6" style="text-align: right">
            <h4>Link Crew Leader</h4>
        ...
        <div class="col-md-6">
            ...
            <p>Reports to: Self</p>
            <ul>
                <li>Manage small group of new high school students</li>
                <li>Assist freshmen in the transition from middle to high school</li>
                <li>Promote interactive and engaging activities for group</li>
            </ul>
        </div>
    </div>
</asp:Content>
