...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                A current student enrolled in this program. To learn more information about this two year diploma program at Centennial College, 
        ...
        <div class="col-md-4">
            <h2>My Resume</h2>
            <p>
                I am actively looking for an entry level or level 1 part-time IT position. 
                Click the icon below or "About Me" in the navigation bar to view my resume.
            </p>
            <p>
